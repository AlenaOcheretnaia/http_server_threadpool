...
public class Request {
    ...
    public static Request fromInputStream(InputStream inputStream) throws IOException {
        ...
        Request myReq = new Request(method, path, parameters, headers, inputStream);

        // вызов методов для демонстрации getQueryParam и getQueryParams
        myReq.getQueryParam("name");
        myReq.queryParamToString();
    ...
    public void queryParamToString() {
